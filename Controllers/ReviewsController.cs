...
namespace Asp_Web_Lib.Controllers
{
    ...
    public class ReviewsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,BookId,UserId,Rating,Comment,Date")] Review review)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,BookId,UserId,Rating,Comment,Date")] Review review)
        {
            if (ModelState.IsValid)
            {
